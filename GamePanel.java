...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void newBall() {
        random = new Random();
        int yPosition = random.nextInt(Math.max(1, GAME_HEIGHT - BALL_DIAMETER));
        ball = new Ball((GAME_WIDTH / 2) - (BALL_DIAMETER / 2), yPosition, BALL_DIAMETER, BALL_DIAMETER);
    }
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                Thread.sleep(10); // Slight pause to control frame rate
